        ...
        <div>
            ...
            <section id="hero" className={styles.maindiv}>
                <div className="justify-center text-center flex flex-col my-auto">
                    ...
                    <Link className="rounded-full border-4 border-grayText text-grayText mx-auto mt-4 px-6 py-2 text-xl font-bold" href="#contact" scroll={false}>Mas Información</Link>
                </div>
            </section>
            ...
            <section id="rifa" className="bg-grayText p-8">
                ...
                <div className="p-8 text-center md:text-right">
                    <Link href="" className="mt-10 rounded-full py-2 px-6 border-2 border-secondary text-secondary font-bold text-2xl">Comprar Boletos</Link>
                </div>
            </section>
